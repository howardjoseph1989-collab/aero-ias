...
import { applyNaturalGlobeControls } from './quickViews.js';
...
async function init() {
  ...
  try {
    ...
    applyNaturalGlobeControls(viewer.scene.screenSpaceCameraController);
    ...
    console.error("AERO IAS initialization failed:", error);
